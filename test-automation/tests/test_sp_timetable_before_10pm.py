...
# TC-014
def test_edit_plans_view_vacancies_before_10pm(get_driver):
    # declare test data
    course_code = "CZ3001"
    ...
    timetables_page.verify_edit_plans_vacancies_and_waitlist(driver, 1, available=True)


# TC-016
def test_saved_plans_view_vacancies_before_10pm(get_driver):
    # declare test data
    course_code = "CZ3001"
    plan_number = 1
